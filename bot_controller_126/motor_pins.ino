...
void right_move(int value){
   analogWrite(right.front_pos,value);
   analogWrite(right.rear_pos,value);
   analogWrite(right.front_gnd,0);
   analogWrite(right.rear_gnd,0);
}
void left_move(int value){
   analogWrite(left.front_pos,value);
   analogWrite(left.rear_pos,value);
   analogWrite(left.front_gnd,0);
   analogWrite(left.rear_gnd,0);  
}
void left_turn(){
  right_move(0);
  left_move(0);
